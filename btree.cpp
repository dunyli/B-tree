...
#include "btree.h"           /* Подключаем публичный API */
 ...
 */
bool
btree_insert(BTree* tree, int key, int value)
{
 ...
 */
bool
btree_search(BTree* tree, int key, int* out_value)
{
 ...
 */
bool
btree_contains(BTree* tree, int key)
{
